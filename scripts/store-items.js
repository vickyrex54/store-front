import { addToCart,calculateCartQuantity } from "../data/checkout-data.js";

import {  products } from "../data/store-item.js";
...
document.querySelector('.js-shoes-items').innerHTML = itemsHTML;
